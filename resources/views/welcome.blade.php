            ...
            <div class="card-body">
              <div class="row counters">
                <div class="col-lg-4 col-md-4 text-center">
                  ...
                  <span data-toggle="counter-up" class="mt-2 text-grey">{{ $positif['value'] }}</span>
                </div>
      
                <div class="col-lg-4 col-md-4 text-center">
                  <h6>Total Sembuh</h6>
                  <img src="/assets/img/icons/happy.png" width="20%" alt="">
                  <span data-toggle="counter-up" class="mt-2 text-green">{{ $sembuh['value'] }}</span>
                </div>
      
                <div class="col-lg-4 col-md-4 text-center">
                  <h6>Total Meninggal</h6>
                  <img src="/assets/img/icons/cry.png" width="20%" alt="">
                  <span data-toggle="counter-up" class="mt-2 text-red">{{ $meninggal['value'] }}</span>
                </div>
              </div>
            </div>
              ...
              <div class="row counters">
                <div class="col-lg-4 col-md-4 text-center">
                  ...
                  @foreach ($indonesia as $data)
                    <span data-toggle="counter-up" class="mt-2 text-grey">{{ $data['positif'] }}</span>
                  @endforeach                    
                </div>
                ...
                <div class="col-lg-4 col-md-4 text-center">
                  ...
                  <img src="/assets/img/icons/happy.png" width="20%" alt="">
                  @foreach ($indonesia as $data)
                    <span data-toggle="counter-up" class="mt-2 text-green">{{ $data['sembuh'] }}</span>
                  @endforeach                    
                </div>
                ...
                <div class="col-lg-4 col-md-4 text-center">
                  ...
                  <img src="/assets/img/icons/cry.png" width="20%" alt="">
                  @foreach ($indonesia as $data)
                    <span data-toggle="counter-up" class="mt-2 text-red">{{ $data['meninggal'] }}</span>
                  @endforeach                    
                </div>
              </div>
            </div>
        ...
        <div class="col-lg-2 col-md-6 portfolio-item filter-{{ $rs['province'] }}">
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-links">
              ...
              <a href="/detail-rs/{{ $rs['id'] }}" title="More Details"><i class="bx bx-link"></i></a>
            </div>
          </div>
        </div>
        @endforeach
